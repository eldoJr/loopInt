import { LayoutDashboard, Settings, ShoppingBag, CreditCard, Users, ArrowRight } from 'lucide-react';
  ...
  const solutions = [
    {
      ...
      description: 'Complete project lifecycle management with task tracking, team collaboration, and deadline management.',
    ...
    },
    {
      icon: Settings,
      title: 'CBM Tools',
      description: 'Comprehensive Business Management tools for operations, processes, and workflow optimization.',
      features: ['Process Automation', 'Workflow Design', 'Performance Metrics', 'Quality Control'],
      color: 'purple',
      href: '#cbm-tools'
    },
    {
      ...
      description: 'Complete inventory and retail management system for fashion and apparel businesses.',
      features: ['Inventory Control', 'Sales Tracking', 'Supplier Management', 'Trend Analysis'],
      color: 'emerald',
    ...
    },
    {
      ...
      description: 'Advanced financial management with invoicing, expense tracking, and comprehensive reporting.',
    ...
    },
    {
      icon: Users,
      title: 'HRMS Platform',
      description: 'Human Resource Management System for employee lifecycle and organizational management.',
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start space-x-6">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-300 ${colorClasses.bg} ${colorClasses.hover}`}>
