        ...
        <div className="absolute bottom-24 right-0 w-96 h-[32rem] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden transform transition-all duration-300 ease-out mb-2 backdrop-blur-sm">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide">
            {filteredItems.length > 0 ? (
              filteredItems.map((item, index) => (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <h4 className="font-medium text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 truncate">{item.title}</h4>
              ...
              <div className="flex flex-col items-center justify-center h-full text-center p-6">
                ...
                <h4 className="font-medium text-gray-700 dark:text-gray-300">No results found</h4>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Try different search terms</p>
              </div>
            )}
          </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex rounded-b-2xl">
            {[
              ...
              >
                <div className={`p-2 rounded-xl transition-all ${activeTab === tab.id ? 'bg-blue-100 dark:bg-blue-500/20 scale-110' : 'hover:bg-gray-200 dark:hover:bg-gray-700'}`}>
