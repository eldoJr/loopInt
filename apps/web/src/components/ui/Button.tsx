...
const Button = memo(
  ({
    ...
    const variants = {
      ...
      secondary:
        'border border-gray-700/50 text-gray-300 hover:bg-gray-800/20 hover:border-gray-600/50',
      outline:
        'border border-gray-700/40 text-gray-300 hover:text-white hover:bg-gray-800/20 hover:border-gray-600/60',
    };
