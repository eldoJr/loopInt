    ...
    >
        ...
        <div className="flex-1 overflow-y-auto pb-16">
          ...
          <div className="p-3">
            ...
            >
              ...
              <ChevronRight className={`w-4 h-4 transition-transform duration-300 group-hover:text-blue-500 ${expandedSections.recent ? 'rotate-90' : ''}`} />
            </button>
            <div className={`space-y-1 overflow-hidden transition-all duration-300 ${expandedSections.recent ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'}`}>
              {recentItems.map((item, index) => {
                const IconComponent = item.icon;
                return (
                  <div key={index} className="flex items-center space-x-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-all duration-200 cursor-pointer group">
          ...
          <div className="p-3">
            ...
            >
              ...
              <ChevronRight className={`w-4 h-4 transition-transform duration-300 group-hover:text-blue-500 ${expandedSections.more ? 'rotate-90' : ''}`} />
            </button>
            <div className={`space-y-1 overflow-hidden transition-all duration-300 ${expandedSections.more ? 'max-h-72 opacity-100' : 'max-h-0 opacity-0'}`}>
              ...
              <div className="flex items-center space-x-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-all duration-200 cursor-pointer group">
                ...
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Goals</span>
              </div>
              <div className="flex items-center space-x-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-all duration-200 cursor-pointer group"
              ...
              <div className="flex items-center space-x-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-all duration-200 cursor-pointer group"
                ...
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Customize sidebar</span>
              </div>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-slate-200/60 dark:border-slate-700/60 bg-gradient-to-t from-slate-100/50 to-transparent dark:from-slate-800/50 backdrop-blur-sm">
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-600 dark:text-slate-400 group-hover:text-slate-800 dark:group-hover:text-slate-200">Give feedback on LoopInt</span>
          </button>
        </div>
    </div>
  );
