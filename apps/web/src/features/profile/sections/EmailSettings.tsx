  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm pt-6">Manage your email address and notification preferences.</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Current email</h3>
        </div>
        <div className="p-6">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Your current email address is <span className="text-gray-900 dark:text-white font-medium">{user?.email || 'user@example.com'}</span>
          </p>
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-600 dark:text-gray-400">Log in with Google enabled</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/50 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Connected account</h3>
      ...
      <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">New email address</h3>
        </div>
