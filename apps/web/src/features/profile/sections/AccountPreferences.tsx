  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm pt-6">Set your general account preferences and defaults.</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl">
        ...
        <div className="p-6 space-y-6">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Changes to your language and timezone will be reflected across Jira, Confluence, Trello, Bitbucket and directory. 
            Update your language and timezone for other products from your{' '}
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Delete your account</h3>
        <p className="text-gray-600 dark:text-gray-400 text-sm">
