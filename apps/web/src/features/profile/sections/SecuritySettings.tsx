      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            authentication with Jira Cloud applications or Confluence Cloud. You
            must use an API token if the Atlassian account you authenticate with
            has had two-step verification enabled. You should treat API tokens
            as securely as any other password.{' '}
            <button className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline">
              Learn more
            </button>
          </p>
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            If you've lost one of your devices or notice any suspicious
            activity, log out of all your devices and take steps to secure your
            account.{' '}
            <button className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline">
              Learn more
            </button>
