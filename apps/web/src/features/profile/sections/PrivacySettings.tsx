  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm pt-6">Control your privacy settings and data sharing preferences.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Activity visibility</h3>
          <p className="text-gray-600 dark:text-gray-400 text-sm">
        ...
        {/* Search Visibility */}
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Search visibility</h3>
          <p className="text-gray-600 dark:text-gray-400 text-sm">
