...
vi.mock('../../../components/performance/LazyComponents', () => ({
  ...
  LazyCalendar: () => (
    <div data-testid="calendar-component">Calendar Component</div>
  ),
  LazyTeam: () => <div data-testid="team-component">Team Component</div>,
  LazyAnalytics: () => (
    <div data-testid="analytics-component">Analytics Component</div>
  ),
  LazyClients: () => (
    <div data-testid="clients-component">Clients Component</div>
  ),
}));
