...
import { Save, X, Upload, Plus, Linkedin, AlertCircle, Bold, Italic, Underline, Calendar, Star, ChartArea } from 'lucide-react';
...
const NewCandidate = ({ onNavigateBack }: NewCandidateProps) => {
  ...
  const handleInputChange = useCallback((field: keyof FormData, value: string | boolean | string[] | File | null | undefined) => {
      ...
      <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl transition-all duration-300">
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700/50">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white">New Candidate</h1>
                ...
                <div className="col-span-9">
                  <div className="flex flex-wrap gap-6">
                    <StarRating
                      ...
                      onRatingChange={(rating) => handleRatingChange('general', rating)}
                      label="General rating"
                    />
                    <StarRating
                      rating={ratings.interpersonal}
                      onRatingChange={(rating) => handleRatingChange('interpersonal', rating)}
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-4">
                  <CustomSelect
                    ...
                    onChange={(value) => handleInputChange('appliedPosition', value)}
                  />
                </div>
              </div>
              ...
              {formData.secondPhone !== undefined && (
                <div className="grid grid-cols-12 gap-3 items-center">
                  ...
                  <div className="col-span-1">
                    <button
                      type="button"
                      onClick={() => handleInputChange('secondPhone', undefined)}
              ...
              {formData.secondEmail !== undefined && (
                <div className="grid grid-cols-12 gap-3 items-center">
                  ...
                  <div className="col-span-1">
                    <button
                      type="button"
                      onClick={() => handleInputChange('secondEmail', undefined)}
                      className="p-1.5 text-red-500 dark:text-red-400 hover:text-red-600 dark:hover:text-red-300 hover:bg-red-100 dark:hover:bg-red-500/10 rounded-lg transition-colors"
                    >
                      <X size={14} />
                    </button>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9">
                  <Toggle
                    ...
                    onPressedChange={(pressed) => handleInputChange('blockCandidate', pressed)}
                  >
                    <span className="text-sm">
                      {formData.blockCandidate ? 'Candidate blocked' : 'Candidate active'}
                    </span>
                  </Toggle>
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9">
                  <CustomSelect
                    ...
                    onChange={(value) => handleInputChange('mainSkills', value.split(', '))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9">
                  <CustomSelect
                    ...
                    onChange={(value) => handleInputChange('skills', value.split(', '))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9">
                  <CustomSelect
                    ...
                    onChange={(value) => handleInputChange('foreignLanguages', value.split(', '))}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-4">
                  <CustomSelect
                    ...
                    onChange={(value) => handleInputChange('currentPosition', value)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9">
                  <input
                    ...
                    onChange={(e) => handleInputChange('previousPosts', e.target.value)}
                    className="w-full bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 rounded-lg px-3 py-1.5 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm"
                  />
                </div>
              </div>
                ...
                <div className="col-span-9">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => handleInputChange('businessTrips', e.target.checked)}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Available for business trips</span>
                  </div>
                </div>
              </div>
