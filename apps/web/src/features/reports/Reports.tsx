...
const Reports = ({
  ...
  onNavigateToEditReport,
  onNavigateToViewReport,
}: ReportsProps) => {
  useTheme();
  ...
  const [reports] = useState<Report[]>([
    {
      ...
      type: 'project',
      description:
        'Comprehensive analysis of project delivery, timeline adherence, and resource utilization across all active projects',
    ...
    },
    {
      ...
      type: 'team',
      description:
        'Weekly team efficiency metrics, task completion rates, and collaboration patterns for optimal workflow management',
    ...
    },
    {
      ...
      type: 'analytics',
      description:
        'Monthly client feedback analysis, satisfaction scores, and improvement recommendations for better service delivery',
    ...
    },
    {
      ...
      type: 'financial',
      description:
        'Quarterly financial overview with project budget tracking, resource allocation, and cost optimization insights',
    ...
    },
    {
      ...
      type: 'analytics',
      description:
        'Bi-weekly quality control analysis, bug tracking, and testing efficiency metrics for continuous improvement',
    ...
    },
    {
      ...
      type: 'team',
      description:
        'Agile sprint analysis with velocity tracking, burndown charts, and team retrospective insights',
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
              Generate comprehensive reports, track KPIs, and gain actionable
              insights to drive project success and team performance.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Create, schedule, and manage comprehensive project reports
              </p>
            </div>
            <button
          ...
          {filteredReports.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Get started by creating your first report to track project
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-2.5 rounded-xl ${getTypeColor(report.type)}`}
                        >
