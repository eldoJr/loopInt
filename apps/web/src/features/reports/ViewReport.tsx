...
import { ArrowLeft, Download, Edit, Share2, Calendar, User, Tag, Clock, FileText, Printer, Mail, Copy, Check, BarChart3 } from 'lucide-react';
    ...
    const loadReport = async () => {
      try {
        ...
        const mockReport: Report = {
          ...
          type: 'project',
          description: 'Comprehensive analysis of project delivery, team productivity, and client satisfaction metrics for Q1 2024',
          status: 'published',
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl p-8">
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">Report not found</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6">The requested report could not be loaded or does not exist</p>
            <button
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="text-blue-900 dark:text-blue-100 font-semibold text-lg">Report Analysis</h4>
            <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">Detailed insights and performance metrics for data-driven decision making.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800/50 rounded-xl shadow-sm">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3">
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white print:text-black">{report.title}</h1>
                <div className={`px-2 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(report.status)} print:bg-gray-100 print:text-gray-800 print:border-gray-300 w-fit`}>
                  {report.status}
                </div>
              </div>
              <p className="text-gray-600 dark:text-gray-400 mb-4 print:text-gray-700">{report.description}</p>
        ...
        <div className="p-4 sm:p-6 print:p-6">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 print:grid-cols-2 print:gap-4">
                <div className="bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 sm:p-6 shadow-sm print:bg-white print:border-gray-300 print:shadow-none">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-4 print:text-black">Performance Overview</h3>
                  <ResponsiveContainer width="100%" height={280}>
                    <BarChart data={performanceData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="2 2" stroke="#f1f5f9" className="dark:stroke-gray-600" opacity={0.5} />
                      <XAxis dataKey="month" stroke="#64748b" className="dark:stroke-gray-400" fontSize={12} tickLine={false} axisLine={false} />
                ...
                <div className="bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 sm:p-6 shadow-sm print:bg-white print:border-gray-300 print:shadow-none">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-4 print:text-black">Project Status</h3>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-4">
                    {projectStatusData.map((item, index) => (
                      <div key={index} className="flex items-center gap-2">
                        ...
                        <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 print:text-gray-700 truncate">{item.name}: {item.value}%</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 sm:p-6 print:bg-white print:border-gray-300 print:shadow-none print:break-inside-avoid">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-6 print:text-black">Team Efficiency Trend</h3>
                <ResponsiveContainer width="100%" height={320}>
                  <LineChart data={performanceData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <YAxis stroke="#64748b" className="dark:stroke-gray-400" fontSize={12} tickLine={false} axisLine={false} />
                    <Tooltip content={<CustomTooltip />} />
                    <Line type="monotone" dataKey="efficiency" stroke="#8B5CF6" strokeWidth={3} dot={{ fill: '#8B5CF6', strokeWidth: 2, r: 5 }} name="Efficiency" />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
          ...
          {activeTab === 'data' && (
            <div className="space-y-6">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white print:text-black">Project Performance Data</h3>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-700/50 print:bg-gray-100">
                      <tr>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-300 uppercase tracking-wider print:text-black">Month</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-300 uppercase tracking-wider print:text-black">Completed</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-300 uppercase tracking-wider print:text-black">Active</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-300 uppercase tracking-wider print:text-black">Efficiency</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700/50 print:divide-gray-300">
                      {performanceData.map((row, index) => (
                        <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700/20 print:hover:bg-transparent">
                          <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white print:text-black">{row.month}</td>
                          <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300 print:text-gray-700">{row.completed}</td>
                          <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300 print:text-gray-700">{row.active}</td>
                          <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300 print:text-gray-700">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium print:px-1 print:py-0 print:rounded-none print:bg-transparent ${
                              row.efficiency >= 90 ? 'bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 print:text-green-800' :
                              row.efficiency >= 80 ? 'bg-yellow-100 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-400 print:text-yellow-800' :
          ...
          {activeTab === 'charts' && (
            <div className="space-y-6 sm:space-y-8">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white print:text-black">Visual Analytics</h3>
                ...
                <div className="bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 sm:p-6 print:bg-white print:border-gray-300 print:shadow-none print:break-inside-avoid">
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <LineChart data={performanceData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      ...
                      <YAxis stroke="#64748b" className="dark:stroke-gray-400" fontSize={12} tickLine={false} axisLine={false} />
                      <Tooltip content={<CustomTooltip />} />
                      <Line type="monotone" dataKey="active" stroke="#10B981" strokeWidth={3} dot={{ fill: '#10B981', strokeWidth: 2, r: 5 }} name="Active" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white print:text-black">Report Configuration</h3>
              <div className="bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 sm:p-6 print:bg-white print:border-gray-300 print:shadow-none">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Auto-generate report</span>
                    <span className="text-green-600 dark:text-green-400 font-semibold print:text-green-800">Enabled</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Include charts</span>
                    <span className="text-green-600 dark:text-green-400 font-semibold print:text-green-800">Yes</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Include data tables</span>
                    <span className="text-green-600 dark:text-green-400 font-semibold print:text-green-800">Yes</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Output format</span>
                    <span className="text-blue-600 dark:text-blue-400 font-semibold print:text-blue-800">PDF</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Schedule</span>
                    <span className="text-purple-600 dark:text-purple-400 font-semibold capitalize print:text-purple-800">{report.schedule || 'None'}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <span className="text-gray-700 dark:text-gray-300 font-medium print:text-gray-800">Last generated</span>
                    <span className="text-gray-600 dark:text-gray-400 print:text-gray-700">{new Date().toLocaleDateString()}</span>
                  </div>
                </div>
              </div>
            </div>
