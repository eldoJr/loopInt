  ...
  const suggestions = [
    {
      ...
      description:
        'Generate a comprehensive team performance report with metrics and insights',
      prompt:
        'Create a monthly performance report analyzing team productivity, task completion rates, and project milestones',
    },
    {
      icon: Zap,
      title: 'Financial Overview',
      description:
        'Create financial reports with budget analysis and revenue tracking',
      prompt:
        'Generate a quarterly financial report including budget analysis, expenses, and revenue projections',
    },
    {
      icon: MessageSquare,
      title: 'Project Status',
      description:
        'Build project status reports with timeline and milestone tracking',
      prompt:
        'Create a project status report showing current progress, upcoming milestones, and potential risks',
    },
  ];
  ...
  const handleGenerate = async () => {
    ...
    setTimeout(() => {
      const mockData: GeneratedReportData = {
        ...
        type: 'analytics',
        description:
          'Comprehensive analysis of team performance metrics, productivity trends, and actionable insights generated by AI.',
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Let AI create your report structure and content
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 mb-6">
        {[1, 2, 3].map(num => (
          <div key={num} className="flex items-center">
            ...
            {num < 3 && (
              <div
                className={`w-10 h-0.5 mx-2 transition-all ${
                  step > num
        ...
        {step === 2 && (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center max-w-sm text-sm">
              AI is analyzing your requirements and creating a comprehensive
              report structure...
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 space-y-3">
              <div>
                ...
                <p className="text-gray-900 dark:text-white mt-0.5 text-sm">
                  {generatedData.title}
                </p>
              </div>
              <div>
                ...
                <p className="text-blue-600 dark:text-blue-400 mt-0.5 capitalize text-sm">
                  {generatedData.type}
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 mt-0.5 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-1">
                  {generatedData.tags.map((tag: string, index: number) => (
                    <span
                      key={index}
                      className="px-2 py-0.5 bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-400 text-xs rounded border border-purple-200 dark:border-purple-500/30"
                    >
                      {tag}
                    </span>
                  ))}
