    ...
    switch (view) {
      ...
      case '3 days':
        return [
          ...
          {
            key: 'tomorrow' as SectionKey,
            title: 'Tomorrow',
            date: format(addDays(today, 1), 'MMM dd'),
            icon: Calendar,
          },
          {
            key: 'thisWeek' as SectionKey,
            title: format(addDays(today, 2), 'EEEE'),
            date: format(addDays(today, 2), 'MMM dd'),
            icon: Calendar,
          },
        ];
      case 'Month':
        return [
          {
            key: 'today' as SectionKey,
            title: 'This Month',
            date: format(today, 'MMMM yyyy'),
            icon: Calendar,
          },
          {
            key: 'later' as SectionKey,
            title: 'Later',
            date: 'Future tasks',
            icon: Clock,
          },
      ...
      default: // Week
        return [
          ...
          },
          {
            key: 'tomorrow' as SectionKey,
            title: 'Tomorrow',
            date: format(addDays(today, 1), 'MMM dd, yyyy'),
            icon: Calendar,
          },
          {
            key: 'thisWeek' as SectionKey,
            title: 'This Week',
            date: `${format(startOfWeek(today), 'MMM dd')} - ${format(endOfWeek(today), 'MMM dd')}`,
            icon: Calendar,
          },
          {
            key: 'later' as SectionKey,
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1">
                              <p
                                className={`font-medium text-sm ${task.status === 'done' ? 'line-through text-gray-500 dark:text-gray-500' : 'text-gray-900 dark:text-white'}`}
                              >
                                {task.title}
                              </p>
                              {task.description && (
                              ...
                              {task.time && (
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                  {format(parseISO(task.time), 'MMM dd, yyyy')}
                                </p>
                              )}
                            </div>
                          </div>
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <button
                                onClick={e => {
                                  e.stopPropagation();
                                  const section = Object.entries(tasks).find(
                                    ([, sectionTasks]) =>
